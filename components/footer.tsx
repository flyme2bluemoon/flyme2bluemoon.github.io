    ...
    <>
      <div className="py-8 bg-blue-400 dark:bg-blue-900">
        <div className="flex space-x-2 justify-center">
          ...
          {/* <Link className="hover:bg-blue-300 dark:hover:bg-blue-700 p-2 rounded-lg" href="https://www.youtube.com/channel/UCbOygd7cfMtsl3nKCJP_8Kg" target="_blank" rel="noopener noreferrer" aria-label="Youtube">
          ...
          {/* <Link className="hover:bg-blue-300 dark:hover:bg-blue-700 p-2 rounded-lg" href="https://twitch.tv/flyme2bluemoon" target="_blank" rel="noopener noreferrer" aria-label="Twitch">
      ...
      <footer className="p-4 bg-white rounded-t-lg shadow md:px-6 md:py-8 dark:bg-gray-800 border-b-8 border-blue-400 dark:border-blue-800">
        <div className="sm:flex sm:items-start sm:justify-between md:mx-16 lg:mx-32 xl:mx-48">
          ...
          {/* <ul className="flex flex-wrap items-center my-6 sm:mb-0">
            <li>
              <Link href="https://github.com/flyme2bluemoon/flyme2bluemoon.github.io" target="_blank" rel="noopener noreferrer" className="mr-4 text-sm text-gray-500 hover:underline md:mr-6 dark:text-gray-400">View on Github</Link>
            </li>
            <li>
