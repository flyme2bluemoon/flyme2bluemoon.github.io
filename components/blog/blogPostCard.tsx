    ...
    <div className="block p-3 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-5">
      <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
        <Link
          ...
          className="mb-2 text-2xl font-bold tracking-tight text-blue-600 hover:underline dark:text-blue-500 flex items-center"
        >
          {title}
        </Link>
      </h2>
        ...
        <div>
          <span className="flex mb-1">
            <svg
              ...
              fill="currentColor"
              className="w-4 h-4 my-auto mr-1 fill-slate-500 dark:fill-slate-300 bi bi-calendar3"
              viewBox="0 0 16 16"
            >
